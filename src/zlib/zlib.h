...
ZEXTERN int ZEXPORT deflatePending OF((z_streamp strm, unsigned *pending,
                                       int *bits));
/*
...
ZEXTERN int ZEXPORT inflateGetDictionary OF((z_streamp strm, Bytef *dictionary,
                                             uInt *dictLength));
/*
