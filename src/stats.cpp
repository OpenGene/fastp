...
void Stats::reportJson(ofstream &ofs, string padding) {
  ...
  ofs << padding << "\t"
      << "\"total_reads\": " << mReads << "," << endl;
  ofs << padding << "\t"
      << "\"total_bases\": " << mBases << "," << endl;
  ofs << padding << "\t"
      << "\"q20_bases\": " << mQ20Total << "," << endl;
  ofs << padding << "\t"
      << "\"q30_bases\": " << mQ30Total << "," << endl;
  ofs << padding << "\t"
      << "\"total_cycles\": " << mCycles << "," << endl;
  ...
  bool first = true;
  ofs << padding << "\t"
      << "\"overrepresented_sequences\": {" << endl;
...
void Stats::reportHtmlORA(ofstream &ofs, string filteringType,
  ...
  ofs << "<div class='subsection_title'><a title='click to hide/show' "
         "onclick=showOrHide('"
...
void Stats::reportHtmlKMER(ofstream &ofs, string filteringType,
  ...
  ofs << "<div class='subsection_title'><a title='click to hide/show' "
      ...
      << divName << "')>" + subsection + "</a></div>\n";
  ofs << "<div  id='" << divName << "'>\n";
  ofs << "<div class='sub_section_tips'>Darker background means larger counts. "
         "The count will be shown on mouse over.</div>\n";
...
void Stats::reportHtmlQuality(ofstream &ofs, string filteringType,
  ...
  ofs << "<div class='subsection_title'><a title='click to hide/show' "
      ...
      << divName << "')>" + subsection + "</a></div>\n";
  ofs << "<div id='" + divName + "'>\n";
  ofs << "<div class='sub_section_tips'>Value of each position will be shown "
         "on mouse over.</div>\n";
