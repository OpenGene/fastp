...
void JsonReporter::setDup(double dupRate) { mDupRate = dupRate; }
...
void JsonReporter::report(FilterResult *result, Stats *preStats1,
  ...
  ofs << "\t"
      << "\"summary\": {" << endl;
  ofs << "\t\t"
      << "\"fastp_version\": \"" << FASTP_VER << "\"," << endl;
  ofs << "\t\t"
      << "\"sequencing\": \"" << sequencingInfo << "\"," << endl;
  ofs << "\t\t"
      << "\"before_filtering\": {" << endl;
  ofs << "\t\t\t"
      << "\"total_reads\":" << pre_total_reads << "," << endl;
  ofs << "\t\t\t"
      << "\"total_bases\":" << pre_total_bases << "," << endl;
  ofs << "\t\t\t"
      << "\"q20_bases\":" << pre_q20_bases << "," << endl;
  ofs << "\t\t\t"
  ...
  ofs << "\t\t"
      << "\"after_filtering\": {" << endl;
  ofs << "\t\t\t"
      << "\"total_reads\":" << post_total_reads << "," << endl;
  ofs << "\t\t\t"
      << "\"total_bases\":" << post_total_bases << "," << endl;
  ofs << "\t\t\t"
      << "\"q20_bases\":" << post_q20_bases << "," << endl;
  ofs << "\t\t\t"
